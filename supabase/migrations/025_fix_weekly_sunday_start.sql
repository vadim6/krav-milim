-- Fix weekly leaderboard to use Sunday as week start instead of Monday.
-- date_trunc('week') gives Monday (ISO); shifting +1 day before truncating
-- and -1 day after converts that to Sunday start.
