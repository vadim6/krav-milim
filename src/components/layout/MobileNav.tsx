...
export default function MobileNav({ isDev }: { isDev?: boolean }) {
  ...
  return (
    <nav data-mobile-nav className={`sm:hidden fixed bottom-0 inset-x-0 z-20 bg-white dark:bg-gray-900 pb-safe border-t ${isDev ? "border-red-600 border-t-2" : "border-gray-200 dark:border-gray-700"}`}>
      <div className="flex">
